package com.tx.common.sdk.constants;
...
public class UmpConstants {
	...
	public static final String SYSTEM_NAME = ""; //Environments.getAppName();
	public static final String SYSTEM_NAME_DEPLOY = ""; //Environments.getAppName();
